...
class MADDPG:
    def __init__(self, state_size, action_size, number_agent, randon_seed=10,  discount_factor=0.95, tau=0.02):
        super(MADDPG, self).__init__()

        self.maddpg_agent = []
        for _ in range(number_agent):
            self.maddpg_agent.append(DDPGAgent(state_size=state_size, action_size=action_size, random_seed=randon_seed))
